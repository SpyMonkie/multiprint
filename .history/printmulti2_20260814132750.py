...
class WatchedMultiPrintApp:
    def __init__(self, root):
        ...
        # Log box
        tk.Label(root, text="Activity Log:", font=("Arial", 9, "bold")).pack(anchor="w", padx=20, pady=(5, 2))
        self.log_box = scrolledtext.ScrolledText(root, height=6, state="disabled", font=("Consolas", 8))
